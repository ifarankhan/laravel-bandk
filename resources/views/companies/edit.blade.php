                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('company.store') }}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="checkbox" name="is_send_email" id="is_send_email" value="true" {{  ($company->is_send_email) ?  'checked="checked"' : '' }} >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="col-md-9" id="emails_div">
                                    <?php
                                    $emails = ($company->emails) ? json_decode($company->emails, true) : [];
                                    ?>
                                    @if(count($emails) > 0)
