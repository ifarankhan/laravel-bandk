...
@section('content')
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('claim-mechanic.index') }}">{{ getTranslation('mechanics_type') }}</a></li>
    </ul>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="{{ route('claim-mechanic.create') }}" class="btn btn-danger pull-right">Create</a>
                ...
                <div class="x_content">
                    ...
                    <table id="datatable1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                        @if(count($claimMechanics) > 0)
                            @foreach($claimMechanics as $claimMechanic)
