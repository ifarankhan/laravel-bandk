                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('category.store') }}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="color" class="form-control col-md-7 col-xs-12" name="color" value="{{ old('color') }}" autocomplete="off">
                                @if ($errors->has('color'))
                                    <span class="help-block" style="color: red;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="checkbox" name="show_on_frontend" id="show_on_frontend" value="true" >
